...
public class RotateCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (pipeSpawner.settingsWindowRect.Contains(mpos)) // Corrected from SettingsWindowRect
                ignore = true;
        }
        ...
        if (!pipeSpawner.IsPaused()) // Ensure IsPaused() is a public method in PipeSpawner
